"""Regression checks for the anchor-trade-orderbook-mesh casebook."""
...
from casebook.harness import assert_expected, anchor_trade_orderbook_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(anchor_trade_orderbook_mesh_summary(), assert_expected())
