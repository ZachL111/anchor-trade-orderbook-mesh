...
`anchor-trade-orderbook-mesh` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for orderbook systems, covering stream reduction, windowed input fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 184. Risk has a penalty of 4, latency has a penalty of 4, and weight contributes a bonus of 5.
